...
#define RUN_PATH_LENGTH 186
const uint8_t run_path[RUN_PATH_LENGTH][2] = {
    ...
    {62, 49}, {63, 49}, {63, 48}, {63, 47}, {63, 46}, {63, 47}, {63, 46},
    {63, 47}, {63, 48}, {63, 49}, {63, 50}, {63, 51}, {63, 52}, {63, 53},
    {63, 52}, {63, 51}, {63, 50}, {63, 49}, {63, 48}, {63, 47}, {63, 46},
    {63, 45}, {63, 44}, {63, 43}, {63, 42}, {63, 41}, {63, 40}, {63, 39},
    {63, 38}, {63, 37}, {63, 36}, {63, 35}, {63, 34}, {63, 33}, {63, 32},
    {63, 31}, {63, 30}, {63, 29}, {63, 28}, {63, 27}, {63, 26}, {63, 25},
    {63, 24}, {63, 23}, {62, 23}, {61, 23}, {60, 23}, {59, 23}, {58, 22},
    {57, 22}, {56, 22}, {55, 22}, {54, 22}, {53, 22}, {52, 22}, {51, 22},
    {51, 23}, {50, 23}, {50, 24}, {49, 24}, {48, 24}, {47, 24}, {47, 25},
    {46, 25}, {45, 25}, {45, 26}, {44, 26}, {44, 27}, {43, 27}, {42, 27},
    {42, 28}, {41, 28}, {40, 28}, {39, 28}, {39, 29}, {38, 29}, {37, 29},
    {37, 30}, {36, 30}, {35, 30}, {35, 31}, {34, 31}, {33, 31}, {32, 31},
    {32, 32}, {31, 32}, {30, 33}, {29, 33}, {28, 33}, {28, 34}, {27, 34},
    {26, 34}, {26, 35}, {25, 35}, {24, 35}, {24, 36}, {23, 36}, {22, 36},
    {22, 37}, {21, 37}, {20, 37}, {20, 38}, {19, 38}, {18, 38}, {17, 39},
    {16, 39}, {15, 39}, {15, 40}, {14, 40}, {15, 40}, {15, 41}, {15, 42},
    {16, 42}, {16, 43}, {16, 44}, {16, 45}, {17, 45}, {17, 46}, {17, 47},
    {17, 48}, {18, 48}, {18, 49}, {18, 50}, {18, 51}, {19, 51}, {19, 52},
    {19, 53}, {20, 53}, {20, 54}, {20, 55}, {20, 56}, {21, 56}, {21, 57},
    {21, 58}, {21, 59}, {22, 59}, {22, 60}, {22, 61}, {22, 62}, {23, 62},
    {23, 63}, {23, 62}, {22, 62}, {22, 61}, {22, 60}, {21, 60}, {21, 59},
    {21, 58}, {21, 57}, {20, 56}, {20, 55},
};
